    ...
    <div style="background-color: #2a2a2a;">
        <div class="h-full  text-white pt-10  ml-2 mr-2">
            <div >
                ...
                <p class=" border-t-2 text-4xl font-bold pt-2  "><span class=" text-sm ml-2 mr-5 font-normal">01</span>  Curiosity</p>
            ...
            <div >
                <img src="../new_incons/svgexport-25.png" class=" h-full  pb-5 ">
                <p class=" border-t-2 text-4xl font-bold pt-2  "><span class=" text-sm ml-2 mr-5 font-normal">02</span>  Adaptability</p>
            ...
            <div >
                <img src="../new_incons/svgexport-26.png" class=" h-full  pb-5 ">
                <p class=" border-t-2 text-4xl font-bold pt-2  "><span class=" text-sm ml-2 mr-5 font-normal">03</span> Collaboration  </p>
            ...
            <div >
                <img src="../new_incons/svgexport-27.png" class=" h-full  pb-5 ">
                <p class=" border-t-2 text-4xl font-bold pt-2  "><span class=" text-sm ml-2 mr-5 font-normal">04</span>  Sustainability</p>
